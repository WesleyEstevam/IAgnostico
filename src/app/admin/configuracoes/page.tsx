...
import { SettingsForm, TurnstileSettingsForm } from "./settings-form";

export default async function SettingsPage() {
  await requirePermission("settings.manage");
  const [settings, supportSettings] = await Promise.all([
  ...
  return <main className="mx-auto max-w-5xl space-y-6 px-4 py-8 sm:px-6 lg:px-8">
    ...
    <TurnstileSettingsForm siteKey={supportSettings.siteKey} secretConfigured={supportSettings.secretConfigured} />

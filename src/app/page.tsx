    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-accent/30 border-y-2 border-border">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-20 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex rounded-full bg-xp/25 text-xp-foreground px-3 py-1 text-xs font-bold uppercase tracking-wider">
              Gamificação
            </div>
            <h2 className="mt-4 text-4xl sm:text-5xl font-extrabold tracking-tight">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="card-pop p-6">
            ...
            <div className="space-y-2 stagger">
              {[
                ...
                <div
                  key={i}
                  className={`flex items-center gap-3 rounded-xl p-3 ${u.me ? "bg-info/10 border-2 border-info/40" : "bg-muted/40"}`}
                >
                  <div
                    className={`h-8 w-8 rounded-lg grid place-items-center text-sm font-extrabold text-white ${u.c}`}
                  >
                    {u.p}
                  </div>
          ...
          <div>
            <div className="inline-flex rounded-full bg-primary/15 text-primary px-3 py-1 text-xs font-bold uppercase tracking-wider">
              Comunidade
            </div>
            <h2 className="mt-4 text-4xl sm:text-5xl font-extrabold tracking-tight">
          ...
          {[
            {
              n: "Marina S.",
              u: "6º ano · UFMG",
              t: "Mudou meu jeito de estudar pra residência. Vicia.",
              c: "#58CC02",
            },
            {
              n: "Rafael T.",
              u: "Interno · UNIFESP",
              t: "Cada caso parece uma fase de jogo. Já bati streak de 45 dias.",
              c: "#1CB0F6",
            },
            {
              n: "Bia L.",
              u: "4º ano · USP",
              t: "Finalmente um app que ensina raciocínio, não decoreba.",
              c: "#FFC800",
            },
          ].map((t, i) => (
            <div key={i} className="card-pop card-jelly p-6">
